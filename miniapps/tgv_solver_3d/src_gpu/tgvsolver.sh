...
#gpu调试
# 编译 CPU 模块，生成调试信息
nvfortran -g -O0 -c commtype.F90 commvar.F90 constdef.F90 commfunc.F90  singleton.F90 filter.F90 derivative.F90 vtkio.F90
...
#nsys调试
    nvfortran -O3 -g -c commtype.F90 commvar.F90 constdef.F90 commfunc.F90  singleton.F90 filter.F90 derivative.F90 vtkio.F90
...
nvfortran -cuda -lineinfo -O0 -traceback -c commtype.F90 commvar.F90 constdef.F90 commfunc.F90  singleton.F90 filter.F90 derivative.F90 vtkio.F90
...
nvfortran -g -O0 -I. tgvsolver.F90 \
    commtype.o commvar.o constdef.o commfunc.o  singleton.o filter.o derivative.o vtkio.o\
    -o tgvsolver
...
#带流场输出的调试
nvfortran -O3 -lineinfo -c commtype.F90 commvar.F90 constdef.F90 commfunc.F90  singleton.F90 filter.F90 derivative.F90 vtkio.F90

nvfortran -O3 -lineinfo -c commarray_gpu.cuf commvar_gpu.cuf commfunc_gpu.cuf fludyna_gpu.cuf bc_gpu.cuf filter_gpu.cuf derivative_gpu.cuf solver_gpu.cuf

nvfortran -O3 -I. tgvsolver.cuf \
    commtype.o commvar.o constdef.o commfunc.o  singleton.o filter.o derivative.o vtkio.o\
    commarray_gpu.o commvar_gpu.o commfunc_gpu.o fludyna_gpu.o bc_gpu.o filter_gpu.o derivative_gpu.o solver_gpu.o\
    -o tgvsolver
